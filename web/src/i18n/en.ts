...
export const en: Translations = {
  ...
  config: {
    fieldLabels: {
      ...
      "terminal_continue": "Terminal Continue",
      ...
      "mcp_discovery_timeout": "Mcp Discovery Timeout",
      "mcp_single_query_discovery_timeout": "Mcp Single Query Discovery Timeout",
      "prefill_messages_file": "Prefill Messages File",
      "timezone": "Timezone",
      "command_allowlist": "Command Allowlist",
      "hooks_auto_accept": "Hooks Auto Accept",
      "live_probe_timeout": "Live Probe Timeout",
      "check": "Check",
      "pre_update_backup": "Pre Update Backup",
      "backup_keep": "Backup Keep",
      "non_interactive_local_changes": "Non Interactive Local Changes",
      "auto_switch_parked_branch": "Auto Switch Parked Branch",
      "parked_branch_strategy": "Parked Branch Strategy",
      "refresh_cua_driver": "Refresh Cua Driver",
      "paste_collapse_threshold": "Paste Collapse Threshold",
      "paste_collapse_threshold_fallback": "Paste Collapse Threshold Fallback",
      "paste_collapse_char_threshold": "Paste Collapse Char Threshold",
    },
