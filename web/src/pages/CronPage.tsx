      ...
      <div className="mt-3 grid gap-3">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div className="grid gap-1">
            <Label htmlFor={`${idPrefix}-provider`}>{t.cron.provider ?? "Provider"}</Label>
            <Select
          ...
          <div className="grid gap-1">
            <Label htmlFor={`${idPrefix}-model`}>{t.cron.model ?? "Model"}</Label>
            <Select
              id={`${idPrefix}-model`}
              value={form.model}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 items-end">
          ...
          <div className="grid gap-1">
            <Label htmlFor={`${idPrefix}-script`}>{t.cron.script ?? "Script"}</Label>
            <Input
              id={`${idPrefix}-script`}
              value={form.script}
        ...
        <div className="grid gap-1">
          <Label htmlFor={`${idPrefix}-workdir`}>{t.cron.workdir ?? "Workdir"}</Label>
          <Input
            id={`${idPrefix}-workdir`}
            value={form.workdir}
