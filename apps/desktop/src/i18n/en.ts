...
export const en: Translations = {
  ...
  desktop: {
    ...
    // Popover / /help copy for the desktop-curated slash commands. Command
    // NAMES stay literal (they are parsed, not read); only the labels below
    // follow the locale.
    slashCommands: {
      ...
      unavailableMessaging: command => `${command} is only used from messaging platforms.`,
      unavailableSettings: command => `${command} is managed from the desktop sidebar.`,
      unavailableTerminal: command => `${command} is only available in the terminal interface.`,
      pickerModel: command => `${command} uses the desktop model picker instead of a slash command.`,
      pickerSession: command => `${command} uses the desktop session picker instead of a slash command.`
    },
